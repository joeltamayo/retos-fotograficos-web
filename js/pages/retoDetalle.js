...
function renderMiParticipacion(refs, participacion) {
	...
	const fotoObj = {
		...
		total_comentarios: Number(participacion.total_comentarios || 0),
		puntuacion_promedio: Number(participacion.puntuacion_promedio || 0),
		prom_creatividad: Number(participacion.prom_creatividad || 0),
		prom_composicion: Number(participacion.prom_composicion || 0),
		prom_tema: Number(participacion.prom_tema || 0),
